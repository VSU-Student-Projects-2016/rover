...
class Human: SKNode {
    ...
    init (pos: CGPoint) {
        ...
        bodyMan.physicsBody?.collisionBitMask =  groundCategory | sawCategory | spikeCategory
        ...
        headMan.physicsBody?.collisionBitMask =  groundCategory | sawCategory | spikeCategory
